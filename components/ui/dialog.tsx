...
const slideIn = {
  left: "data-[state=open]:slide-in-from-left-1/2",
  right: "data-[state=open]:slide-in-from-right-1/2",
} as const;

const slideOut = {
  left: "data-[state=closed]:slide-out-to-left-1/2",
  right: "data-[state=closed]:slide-out-to-right-1/2",
} as const;
...
const DialogContent = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof DialogPrimitive.Content> & {
    showClose?: boolean;
    slideFrom?: keyof typeof slideIn;
    slideOutTo?: keyof typeof slideOut;
  }
>(
  (
    {
